-# This is an example of implementing a search algorithm using the generic Node and problem class.		
 ...
 -  # The path is not being used in this demo, but this lines shows how to record it if needed		
 -  # If the path is not being recorded, this line of code is unnecessary (but fine to stay too)		
 -  if problem.recordPath : Node.recordPath		
 -		
